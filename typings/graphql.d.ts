...
export enum MarkdownRemarkFieldsEnum {
  ...
  FrontmatterLetter = 'frontmatter___letter',
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  letter?: Maybe<StringQueryOperatorInput>;
...
export type GlossaryEntryBySlugQueryVariables = {
  slug: Scalars['String'];
};

export type GlossaryEntryBySlugQuery = { __typename?: 'Query' } & {
