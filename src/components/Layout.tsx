...
export const Layout: React.FunctionComponent = ({ children }) => (
  <div className="container mx-auto">
    <h1 className="text-5xl md:text-6xl font-thin text-gray-900 text-center p-12">
    ...
    <div className="bg-white m-5 md:m-20 shadow h-full p-5 md:p-10 rounded">{children}</div>
